                            ...
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text:
                                        ' hours to complete the verification process. You will receive a notification once your profile has been successfully verified.',
                                    style: TextStyle(
                                      color:
                                          FlutterFlowTheme.of(context).primary,
                                    ),
                                            ...
                                            onPressed: () async {
                                              if (valueOrDefault<bool>(
                                                ...
                                                if (valueOrDefault(
                                                    ...
                                                    'Mentor') {
                                                  context
                                                      .pushNamed('MentorHome');
                                                } else {
                                                  context
                                                      .pushNamed('MenteeHome');
                                                }
                                              } else {
                                                await showDialog(
                                                  context: context,
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title:
                                                          Text('Oops! Wait!'),
                                                      content: Text(
                                                          'You haven\'t been verified by Admin yet.'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
