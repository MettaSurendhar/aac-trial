...
import 'mentor_profile_edit_model.dart';
export 'mentor_profile_edit_model.dart';

class MentorProfileEditWidget extends StatefulWidget {
  const MentorProfileEditWidget({super.key});

  @override
  State<MentorProfileEditWidget> createState() =>
      _MentorProfileEditWidgetState();
}

class _MentorProfileEditWidgetState extends State<MentorProfileEditWidget> {
  late MentorProfileEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentorProfileEditModel());
    ...
    _model.graduationYearTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.gradYear, 0).toString());
    _model.graduationYearFocusNode ??= FocusNode();

    _model.branchTextController1 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.branch, ''));
    _model.branchFocusNode1 ??= FocusNode();

    _model.branchTextController2 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.linkedinUrl, ''));
    _model.branchFocusNode2 ??= FocusNode();

    _model.personalStatementTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.personalStatement, ''));
                                            ...
                                            child: Padding(
                                              ...
                                              child: AuthUserStreamWidget(
                                                builder: (context) =>
                                                  ...
                                                  validator: _model
                                                      .branchTextController1Validator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: AuthUserStreamWidget(
                                                    builder: (context) =>
                                                      ...
                                                      validator: _model
                                                          .branchTextController2Validator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                    ...
                                    await currentUserReference!.update({
                                      ...createUsersRecordData(
                                        ...
                                        personalStatement: _model
                                            ...
                                            .text,
                                        linkedinUrl:
                                            _model.branchTextController2.text,
                                      ),
                                      ...mapToFirestore(
                                        {
                                          'areas_interest':
