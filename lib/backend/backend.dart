...
/// Functions to query MentorshipsRecords (as a Stream and as a Future).
Future<int> queryMentorshipsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MentorshipsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MentorshipsRecord>> queryMentorshipsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MentorshipsRecord.collection,
      MentorshipsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MentorshipsRecord>> queryMentorshipsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
