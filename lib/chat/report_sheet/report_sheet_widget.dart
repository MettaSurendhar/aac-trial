...
class ReportSheetWidget extends StatefulWidget {
  ...
  final DocumentReference? byUser;
  final DocumentReference? onUser;
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 8.0, 0.0, 0.0),
                                child: Text(
                                  'Enter your report message here',
                                        ...
                                        onPressed: () async {
                                          await UserReportsRecord.collection
                                              ...
                                              .set(createUserReportsRecordData(
                                                reportedBy: widget!.byUser,
                                                reportedOn: widget!.onUser,
                                                reportMessage: _model
