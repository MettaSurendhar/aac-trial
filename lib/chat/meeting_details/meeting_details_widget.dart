...
class MeetingDetailsWidget extends StatefulWidget {
  const MeetingDetailsWidget({
    ...
    required this.theirRef,
  });

  final DocumentReference? chatRef;
  final DocumentReference? theirRef;
                                ...
                                child: StreamBuilder<List<MeetingsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          listViewMeetingsRecordList.length,
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (_model
                                                                        ...
                                                                        await listViewMeetingsRecord
                                                                          ...
                                                                          ...mapToFirestore(
                                                                            {
                                                                              'accepted_users': FieldValue.arrayUnion([
                                                    ...
                                                    children: [
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'From: ${listViewMeetingsRecord.startTime?.toString()}',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          children: [
                                                            Text(
                                                              'To: ${listViewMeetingsRecord.endTime?.toString()}',
                                  ...
                                  stream: queryMeetingsRecord(
                                    ...
                                    queryBuilder: (meetingsRecord) =>
                                        meetingsRecord
                                            .where(
                                              'created_user',
                                              isEqualTo: widget!.theirRef,
                                            )
                                            .where(
                                              'receiver_state',
                                              isNotEqualTo: RequestState
                                                  .REJECTED
                                                  .serialize(),
                                            ),
                                  ),
