...
import 'chat_main_mentee_model.dart';
export 'chat_main_mentee_model.dart';

class ChatMainMenteeWidget extends StatefulWidget {
  const ChatMainMenteeWidget({super.key});

  @override
  State<ChatMainMenteeWidget> createState() => _ChatMainMenteeWidgetState();
}

class _ChatMainMenteeWidgetState extends State<ChatMainMenteeWidget> {
  late ChatMainMenteeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatMainMenteeModel());
