...
class _ChatMainWidgetState extends State<ChatMainWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (valueOrDefault(currentUserDocument?.refreshToken, '') == null ||
          valueOrDefault(currentUserDocument?.refreshToken, '') == '') {
        _model.reqToken = await actions.getRequestToken();

        await currentUserReference!.update(createUsersRecordData(
          refreshToken: _model.reqToken,
        ));
      }
    });
